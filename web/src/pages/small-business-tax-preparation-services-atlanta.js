...
const Page = ({ data }) => {
  ...
  return (
    <Layout headerDarkMode={true}>
        ...
        <div className="container">
          <div className="relative grid md:grid-cols-12 md:gap-x-10 lg:gap-x-16 gap-y-8 items-center">
            <div className="md:col-start-1 md:col-span-10">
              <GatsbyImage
                image={data.incomeTaxDesktop.childImageSharp.gatsbyImageData}
              />
            </div>
            <div className="md:absolute bg-primary-700 shadow-inner md:col-start-6 md:col-span-7 p-20">
              ...
              <p className="font-light text-base text-primary-200 mb-6">
                Ease the stress of taxes with professional tax preparation. And
                if you’re already using us to manage your financial statements
                and payroll, taxes get even easier!
              </p>
              {/* <ButtonSolidGold
        ...
        <div className="container">
          <div className="relative grid md:grid-cols-12 lg:gap-x-16 items-center">
            <div className="md-hidden">
              <GatsbyImage
                image={data.incomeTaxMobile.childImageSharp.gatsbyImageData}
              />
            </div>
      ...
      <section className="mt-12 flex justify-content items-center flex-col">
        <div className="flex justify-content items-center flex-col md:mx-70 md:min-w-120 sm:mx-8 px-7">
          <p className="text-4xl-x font-thin mb-6 text-center md:text-start">
            Streamlined Business & Personal Tax Preparation
          </p>
          <p className="text-xl font-light leading-7 text-center md:text-start mb-10 md:mb-0">
            When we do your accounting and payroll, it flows directly into your
            business tax return and delivers the data with the highest accuracy.
            And from there, the relevant information is imported directly to
        ...
        <div className="container">
          <div className="lg:flex items-start md:block">
            ...
            <div className="flex justify-center flex-col lg:w-1/2 md:w-full md:mb-8 sm:mb-8">
              <div className="md:pl-10 pl-0">
                ...
                <p className="text-base font-light  mb-6">
                  At High Echelon, we prepare your returns and help you handle
                ...
                <div className="text-base font-light">
                  ...
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Assistance with IRS tax notices
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
            ...
            <div className="hidden md:block md:w-1/2 mr-0 md:mr-20 md:mb-8 mb-8">
              <GatsbyImage
                image={data.taxPrepImage.childImageSharp.gatsbyImageData}
                alt="Small Business Consulting"
            ...
            <div className="block md:flex justify-center flex-col lg:w-1/2 md:w-full mt-10 md:mt-0">
              <div className="px-0 md:px-10">
                ...
                <p className="text-base font-light">
                  First, we'll review your prior year tax return(s) and discuss
                  any questions or concerns you might have. Next, we will
                  discuss any significant changes that might've occurred during
                  the most recent tax year, and give you an idea of how that
                  change might (or might not) affect your income taxes. And
                  finally, we will prepare a proposal denoting the scope of work
                  and then once you sign we will get started.
                </p>
              ...
              >
                ...
                <div className="justify-center flex-col py-2">
                  ...
                  <p className="text-base">
                    Lighten your load with automated payroll processing, hiring,
                    and termination.
                  </p>
                </div>
              </AniLink>
      ...
      <CallToAction subtext="Call today to get started on professional tax preparation services from High Echelon, your premier Atlanta, Georgia, CPA." />
      <svg
        className="w-full"
        width="1200"
        height="3"
