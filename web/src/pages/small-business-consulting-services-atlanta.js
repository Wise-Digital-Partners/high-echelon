        ...
        <div className="container">
          <div className="relative grid md:grid-cols-12 md:gap-x-10 lg:gap-x-16 gap-y-8 items-center">
            <div className="md:col-start-1 md:col-span-10">
              <GatsbyImage
                image={data.consultingDesktop.childImageSharp.gatsbyImageData}
              />
            </div>
            <div className="md:absolute bg-primary-700 shadow-inner md:col-start-6 md:col-span-7 p-20">
              ...
              <p className="font-light text-base text-primary-200">
                Looking to get started with forming a business, or need to
                restructure an already existing business?
              </p>
              {/* <ButtonSolidGold
        ...
        <div className="container">
          <div className="relative grid md:grid-cols-12 lg:gap-x-16 items-center">
            <div className="md-hidden">
              <GatsbyImage
                image={data.consultingMobile.childImageSharp.gatsbyImageData}
              />
            </div>
      ...
      <section className="mt-12 flex justify-content items-center flex-col">
        <div className="flex justify-content items-center flex-col md:mx-88 md:min-w-120 sm:mx-8 px-7">
          ...
          <p className="text-xl font-light leading-7 text-center md:text-start mb-10 md:mb-0">
            Are you just getting started? Deciding how to structure your new
            business is a critical first step and can have enormous
            implications. Or are you already operating a business and need to
            make a shift? Smart advice starts here.
          </p>
        </div>
            ...
            <div className="flex justify-center flex-col lg:w-1/2 md:w-full md:mb-8 sm:mb-8">
              <div className="md:pl-10 pl-0">
                ...
                <p className="text-base font-light  mb-6">
                  At High Echelon, we draw on a long history of best practices
                  to help small you move forward with confidence. Our small
                ...
                <div className="text-base font-light">
                  ...
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Talk out the pros and cons of different approaches
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Advise you on a big purchase or sale that may be on the
                      horizon
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:flex items-center md:block">
            ...
            <div className="block md:flex justify-center flex-col lg:w-1/2 md:w-full mt-10 md:mt-0">
              <div className="px-0 md:px-10">
                ...
                <p className="text-base font-light  mb-6">
                  We begin with an introductory call at no cost to you. First,
                  we want to understand your goals and align on expectations,
                  timeline, and outcomes. And from there, we’ll present you with
                  a proposal outlining a plan and the associated costs.
                </p>
                {/* <ButtonSolidGold
                                className="font-light"
                                onClick={()=>openContactModal()}
