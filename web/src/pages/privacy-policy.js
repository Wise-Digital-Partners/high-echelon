    ...
    <Layout headerDarkMode={true}>
      <section className="pt-12 md:pt-16 pb-20 md:pb-32">
        <div className="container">
          ...
          <p>
            The High Echelon P.C. website may use "cookies" to help you
          ...
          <h3 className="text-primary-700">Children Under Thirteen</h3>
          <p>
          ...
          <p>
            From time to time, High Echelon P.C. may contact you via email for
          ...
          <p>
            High Echelon P.C. reserves the right to change this Privacy Policy
          ...
          <p>
            Email Address: info@highecheloncpa.com
            <br />
          </p>
