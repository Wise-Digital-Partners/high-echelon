      ...
      />
        ...
        <section className="hidden md:block mb-20 md:mb-32 mt-12">
            <div className="container ">
                ...
                Help your clients and support your business with High Echelon’s Referral Program for Financial Advisors & Planners.
                        </p>
                        {/* <ButtonSolidGold
        ...
        <section className="mt-12 flex justify-content items-center flex-col">
          ...
          <p className="text-4xl-x font-thin mb-6 text-center md:text-start">Being a Trusted Advisor Means Connecting Clients to Experts</p>
                <p className="text-xl md:w-[760px] font-light leading-7 text-center md:text-start mb-10 md:mb-0">
            A core component of success for anyone in a consultative/advisory role is connecting clients with other trusted partners they need on their pathway to success.
                </p>
            </div>
        ...
        <section className="mb-20 md:mb-32 mt-12">
            <div className="container">
                ...
                <p className="text-4xl font-thin mb-6">How It Works
</p>
                            <p className="text-base font-light  mb-6">
We work together in three main ways:                            </p>
                            <div className="text-base font-light">
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Affiliate/Commission - for every qualified client you refer to us, you earn a percentage of all recurring revenue billed to them.</p>
                                </div>
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Referrals from us - clients reach out to us looking for an advisor. Let us refer them to you!</p>
                                </div>
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Cobranded Marketing/Sales campaigns - we can work together to do email, event, and webinar-based campaigns to our combined customer lists for cross-selling opportunities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section className="mb-20 md:mb-32 mt-12">
            <div className="container">
                ...
                <p className="text-4xl font-thin mb-6">How To Get Started
                            ...
                            <p className="text-base font-light  mb-6">
                  We would love to discuss if this would be a good fit for your clients and ours! Please schedule an introductory call with us, so we can get a chance to meet one another and learn about the mutual opportunity to partner together.
                            </p>
