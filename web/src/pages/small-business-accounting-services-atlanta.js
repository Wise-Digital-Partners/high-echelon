          ...
          <div className="relative grid md:grid-cols-12 md:gap-x-10 lg:gap-x-16 gap-y-8 items-center">
            ...
            <div className="md:absolute bg-primary-700 shadow-inner md:col-start-6 md:col-span-7 p-20">
              ...
              <p className="font-light text-base text-primary-200">
                You can’t manage a business without accurate financial
                statements. We can get you there.
              </p>
              {/* <ButtonSolidGold
              ...
              <div className="md:pl-10 pl-0">
                ...
                <div className="text-base font-light">
                  ...
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Prepare your monthly/quarterly/annual financial statements
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Provide prompt delivery of financial statements on
                      schedule
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      File your sales tax (within all 50 states)
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      File your property taxes, including your personal and
                      county filings
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:flex items-center md:block">
            ...
            <div className="block md:flex justify-center flex-col lg:w-1/2 md:w-full mt-10 md:mt-0">
              <div className="px-0 md:px-10">
                ...
                <p className="text-base font-light  mb-6">
                  We use the latest tools to ensure your data is streamlined and
                  secure. When you partner with us, you get not only exceptional
                  service but also:
                </p>
                <div className="text-base font-light">
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Efficient, automated onboarding
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                  ...
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Secure, encrypted transmission and storage of your
