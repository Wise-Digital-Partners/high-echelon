...
const Page = ({ data }) => {
  ...
  return (
    <Layout headerDarkMode={true}>
          ...
          <div className="relative grid md:grid-cols-12 md:gap-x-10 lg:gap-x-16 gap-y-8 items-center">
            ...
            <div className="md:absolute bg-primary-700 shadow-inner md:col-start-6 md:col-span-7 p-20">
              ...
              <p className="font-light text-base text-primary-200">
                Payroll doesn't have to be a burden. Let us lighten the load
                with automated online services, including payroll processing,
                hiring, and termination. We set you up on our top-rated
                cloud-based payroll management platform, Gusto, and you get
                direct support from High Echelon.
              </p>
              {/* <ButtonSolidGold
      ...
      <section className="mt-12 flex justify-content items-center flex-col">
        <div className="flex justify-content items-center flex-col md:mx-88 md:min-w-120 sm:mx-8 px-7">
          ...
          <p className="text-xl font-light leading-7 text-center md:text-start mb-10 md:mb-0">
            Your payroll will be a breeze—whether you’re starting for the first
            time or want to transition away from one of the ‘big box’ providers.
            We set you up on our top-rated cloud-based payroll management
            platform, Gusto, and you get direct support from founder Michelle
            Frank.
          </p>
        </div>
        ...
        <div className="container">
          <div className="lg:flex items-center md:block">
            ...
            <div className="flex justify-center flex-col lg:w-1/2 md:w-full md:mb-8 sm:mb-8">
              <div className="md:pl-10 pl-0">
                ...
                <p className="text-base font-light  mb-6">
                  You get comprehensive payroll services that’ll keep you on
                  track and ensure you meet deadlines. You’ll easily
                </p>
                <div className="text-base font-light">
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Process payroll for employees and contractors—check or
                      direct deposit
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Track and schedule PTO
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Track payroll benefits and deductions
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Onboard and offboard new and outgoing employees
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Get instant year-end W2 and 1099 form processing and
                      filing
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Process electronic payments of all payroll tax payments
                    </p>
                  </div>
                  <div className="flex">
                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">
                      Complete electronic filing of all quarterly and annual
            ...
            <div className="hidden md:block md:w-1/2 mr-0 md:mr-20 md:mb-8 mb-8">
              <GatsbyImage
                image={data.payrollProfile.childImageSharp.gatsbyImageData}
                alt="Small Business Consulting"
        ...
        <div className="container">
          <div className="lg:flex items-center md:block">
            <div className="lg:w-1/2 md:w-full mr-0 md:mr-20 md:mb-8 sm:mb-8">
              <GatsbyImage
                image={data.payrollImage.childImageSharp.gatsbyImageData}
                alt="Small Business Consulting"
                className="rounded-[8px] w-full"
              />
            </div>
            <div className="block md:flex justify-center flex-col lg:w-1/2 md:w-full mt-10 md:mt-0">
              <div className="px-0 md:px-10">
                ...
                <p className="text-base font-light  mb-6">
                  Onboarding is paperless and can be completed inside a
                  day—we'll show you how easy it is! Additionally, employees
                  have their own portal to enter their information directly. And
                  once you're completely set up, onboarding and offboarding
                  employees take just two minutes.
                </p>
                {/* <ButtonSolidGold
                                className="font-light"
                                onClick={()=>openContactModal()}
          ...
          <div className="gap-y-8 md:gap-x-10 lg:gap-x-16">
            <div className="mb-8 flex justify-center items-center flex-col">
              ...
              <p className="md:w-2/3 sm:w-full text-xl md:text-base sm:text-base font-light mb-12">
                Get the best results when you combine our expert advice with
                end-to-end services that manage your finances in a full-stack
                solution.
              </p>
            </div>
            <div className="md:flex sm:block">
              ...
              >
                ...
                <div className="justify-center flex-col py-2">
                  ...
                  <p className="text-base">
                    Gain a clear understanding of your financials so you can
              ...
              >
                ...
                <div className="justify-center flex-col py-2">
                  ...
                  <p className="text-base">
                    Remove the stress of taxes with professional tax preparation
                    and an IRS liaison.
                  </p>
                </div>
              </AniLink>
              ...
              >
                ...
                <div className="justify-center flex-col py-2">
                  ...
                  <p className="text-base">
                    Get wise advice on starting a new business or restructuring
                    an existing one.
                  </p>
                </div>
              </AniLink>
      ...
      <CallToAction subtext="Automate your payroll and start saving time immediately with payroll management services from High Echelon, your premier Atlanta, Georgia, CPA." />
      <svg
        className="w-full"
        width="1200"
        height="3"
