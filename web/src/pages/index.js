...
const Page = ({ data }) => {
  ...
  return (
    <Layout className="bg-secondary-400" headerDarkMode={true}>
          ...
          <div className="gap-y-8 md:gap-x-10 lg:gap-x-16 items-center mt-8">
            ...
            <div className="block w-full md:flex lg:flex md:mb-5 mb-4">
              <AniLink fade to="/small-business-consulting-services-atlanta/" className=" block w-full mr-0 md:flex lg:flex md:mr-5 md:w-1/2 lg:mr-5 lg:w-1/2">
                <GatsbyImage
                  ...
                  className="p-2 rounded-[8px] mb-3 md:w-[190px] w-full"
                />
                <div className="md:flex md:justify-center  py-2 pl-6 mb-6 md:mb-0 max-w-[360px]">
            ...
            <div className="block w-full md:flex lg:flex md:mb-5 mb-4">
              <AniLink fade to="/payroll-management-services-atlanta/" className=" block w-full mr-0 md:flex lg:flex md:mr-5 md:w-1/2 lg:mr-5 lg:w-1/2">
                <GatsbyImage
                  image={
                    data.coachBusinessConsultingImage.childImageSharp.gatsbyImageData
                  }
                  alt="Small Business Consulting"
                  className="p-2 rounded-[8px] mb-3 md:w-[190px] w-full"
                />
      ...
      <Testimonials />
      <About />
      <svg className="w-full" width="1200" height="3" viewBox="0 0 1200 3" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 1.5h1200" stroke="url(#paint0_linear_1129_1425)" strokeWidth="3" /><defs>
        <linearGradient id="paint0_linear_1129_1425" x1="0" y1="2.00435" x2="1182.95" y2="1.96651" gradientUnits="userSpaceOnUse"><stop stopColor="#A2A09D" stopOpacity="0" /><stop offset=".145833" stopColor="#CB9636" /><stop offset=".265625" stopColor="#CFA855" /><stop offset=".427083" stopColor="#FCE4A7" /><stop offset=".578125" stopColor="#F0D592" /><stop offset=".713542" stopColor="#CFA855" /><stop offset=".828125" stopColor="#CB9636" /><stop offset="1" stopColor="#A7A7A7" stopOpacity="0" />
