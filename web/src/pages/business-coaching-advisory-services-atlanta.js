...
import Accordian from "../components/Accordion/CoachingAccordion";
  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        ...
        description="Learn how to get your financials in order and make the right set of changes to get a better outcome. High Echelon works alongside you. Book a call today.
        "
      />
        ...
        <section className="hidden md:block mb-20 md:mb-32 mt-12">
            <div className="container ">
              ...
              <GatsbyImage image={data.startImage.childImageSharp.gatsbyImageData} />
                ...
                Tired of running your business from the backstep? We bring order to the chaos.
                        </p>
                        {/* <ButtonSolidGold
        ...
        <section className="mt-12 flex justify-content items-center flex-col">
          ...
          <p className="text-4xl-x font-thin mb-6 text-center md:text-start">Focus on Growth. Make a Change.</p>
          <p className="text-xl md:w-[760px] font-light leading-7 text-center md:text-start mb-10 md:mb-0">
            The first step to best practice-driven business management is getting your financials in order. But once that’s done, you need to make the right set of changes to get a better outcome. Let us work alongside you.
                </p>
            </div>
        ...
        <section className="mb-20 md:mb-32 mt-12">
            <div className="container">
                ...
                <p className="text-4xl font-thin mb-6">How We Can Help You and Your Small Business
</p>
                            <p className="text-base font-light  mb-6">
                  Being a business owner can be lonely. There are very few people you can have an open and honest conversation with about your business’s failures, successes, and plans. We help you have a sounding board for what you want to accomplish and how to get there.
                            </p>
                            <div className="text-base font-light">
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Focus on benchmarking, best practices, and process</p>
                                </div>
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Advanced reporting and dashboards showing where you’re succeeding and where you need to focus your attention</p>
                                </div>
                                <div className="flex">
                                    <i className="fa fa-check text-primary-100 mr-3"></i>
                    <p className="text-base font-semibold mb-3">Leading the process of building a budget to measure performance against</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section className="mb-20 md:mb-32 mt-12">
            <div className="container">
                ...
                <p className="text-4xl font-thin mb-6">How To Get Started
                            ...
                            <p className="text-base font-light  mb-6">
                  We begin with an introductory discovery call at no cost to you. We will ask lots of questions! We want to understand where you are, where you've been, and where you'd like to go. The goal of this call is to determine if there is a great fit between your goals and our approach.
                            </p>
...
export const query = graphql`
  {
    ...
    serviceImage: file(
        relativePath: { eq: "common/Coaching_2.0-tools.png" }
    ) {
      childImageSharp {
        gatsbyImageData(layout: FULL_WIDTH, placeholder: NONE)
      }
  ...
  accountingGetStarted: file(
      relativePath: { eq: "common/Referrals_3.0get-started.jpg" }
  ) {
    childImageSharp {
      gatsbyImageData(layout: FULL_WIDTH, placeholder: NONE)
    }
