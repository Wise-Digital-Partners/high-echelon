        ...
        <div className="container">
          <div className="lg:flex items-center md:block">
            ...
            <div className="md:hidden mb-10">
              <GatsbyImage
                image={data.quotesMobile.childImageSharp.gatsbyImageData}
                alt="Small Business Consulting"
                className="rounded-[8px]"
              />
            </div>
            <div className="block w-full md:flex justify-center flex-col lg:w-1/2">
              <div className="md:px-4">
                <p className="text-4xl md:text-5xl font-thin mb-6">
        ...
        <div className="container">
          <div className="flex justify-center">
            ...
            >
              <line
                ...
                x2="1197"
                y2="1.5"
                stroke="url(#paint0_linear_1186_1352)"
                strokeWidth="3"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_1186_1352"
                  x1="0"
                  y1="3.50435"
                  x2="1168.5"
                  y2="3.45905"
          ...
          <div className="flex justify-center items-center flex-col">
            <div className="mt-20 md:mt-28 mx-0 text-center lg:px-44 md:px-20">
              <p className="text-4xl md:text-4xl-x font-thin mb-6">
                Our Mission
              </p>
              <p className="text-base font-light">
                High Echelon provides top-quality work with total transparency.
                We believe accounting doesn’t need to be complicated and that
                clients should get the experience they deserve, which includes:
              </p>
            </div>
            ...
            <div className="lg:w-7/12 flex items-start justify-center flex-col lg:px-16 md:px-4 sm:px-2 mr-30 sm:w-full mb-8">
              ...
              <div className="text-base text-light mb-6">
                <p>
                  ...
                  joining the team at Peachtree Capital (PeachCap), then later
                  starting her own business, High Echelon.
                </p>
                <p className="mb-0">
                  Michelle received her undergraduate degree at Emory and
                  post-graduate at Georgia State University. When she isn’t
                  being a top Atlanta CPA, she’s running marathons, hosting a
                  podcast, and raising three girls.
                </p>
              </div>
              {/* <ButtonSolidGold
                  className="font-light"
...
export const query = graphql`
  {
    ...
    michellProfileImage: file(
      relativePath: { eq: "6.0 About/3.0 Michelle.jpg" }
    ) {
      childImageSharp {
