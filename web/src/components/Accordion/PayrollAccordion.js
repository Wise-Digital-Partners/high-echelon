            ...
            <Fragment>
                <Accordion open={open === 1} onClick={() => handleOpen(1)}>
                    <AccordionHeader className="text-xl subheader">
                        <p className="my-0  w-11/12 text-left text-xl">How many days before payroll is due would the funds need to be available?</p>
                    </AccordionHeader>
                    <AccordionBody>
                        <p>You’ll need to have the funds available two business days before payroll is due.</p>
                    </AccordionBody>
                </Accordion>
                <Accordion open={open === 2} onClick={() => handleOpen(2)}>
                    ...
                    <AccordionBody>
                        <p className="mb-0">
                            It depends on the frequency of payroll being run. 
                            The payroll management system provides substantial communications before taxes are due.
                        </p>
                    </AccordionBody>
                </Accordion>
