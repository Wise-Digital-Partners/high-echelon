  ...
  return (
    <Fragment>
      <Accordion open={open === 1} onClick={() => handleOpen(1)}>
        <AccordionHeader className="text-xl subheader">
          <p className="my-0  w-11/12 text-left text-xl">
            What is classified as a business expense vs. what is personal?
          </p>
        </AccordionHeader>
        <AccordionBody>
          <p>
            Business expenses are deductible. They can lower your taxable income
            and reduce the amount of tax you owe.
          </p>
          <p>
            Understanding the difference between business and personal expenses
            is crucial for small business owners. The IRS doesn’t have a
            comprehensive list of all allowable business deductions. Instead, it
            offers the general rule that any expense that is ordinary and
            necessary for running your business is deductible. If not, then it’s
            a personal expense.
          </p>
      ...
      <Accordion open={open === 3} onClick={() => handleOpen(3)}>
        ...
        <AccordionBody>
          <p>
            If you own a business or are self-employed, you can deduct car
            expenses on your tax returns if you use the vehicle for business.
          </p>
          <p>
            When a vehicle is used for business and personal needs, you’re
            required to track and split the expenses. The portion of mileage
            used for your business is what can be deducted from your tax
            returns.
          </p>
        </AccordionBody>
      </Accordion>
