  ...
  const data = useStaticQuery(graphql`
    {
      ...
      icon2: file(
        relativePath: { eq: "repeating/value-props/02-Technology.svg" }
      ) {
        publicURL
      }
      icon3: file(
        relativePath: { eq: "repeating/value-props/03-Billing.svg" }
      ) {
        publicURL
      }
    ...
    <section className={`${className || "bg-primary-700 mb-20 md:mb-32"}`}>
      <div className="container">
        <header className="md:hidden lg:hidden md:max-w-2xl md:mx-auto text-center pt-24 mb-10">
          <HeadingTag className="text-primary-200 font-light text-4xl">
            {heading || "Why US?"}
          </HeadingTag>
        </header>
              ...
              >
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-primary-500 text-base mb-0">
                      {content.text}
                    </p>
                  </div>
                </div>
