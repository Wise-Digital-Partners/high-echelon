      ...
      <div className="pb-8 space-y-6 md:px-20 px-2">
        ...
        <div className="mb-10 text-black md:flex block">
          <button
            className={
              bookCall === 1
                ? "w-full md:w-1/2 block md:flex justify-center items-center border-black bg-primary-100 py-2 text-white mb-3 md:mb-0"
                : "block w-full md:w-1/2 md:flex justify-center items-center bg-gray-200 py-2 mb-3 md:mb-0"
            }
        ...
        {bookCall === 0 ? (
              ...
              <div className="mb-8">
                ...
                <div className="block md:flex">
                  ...
                  <div className="mb-5 md:w-1/2">
                    <label
                      className="font-body  font-semibold text-gray-900 block mb-1 text-base"
                ...
                <div className="mb-5">
                  ...
                  <select
                    name="service-option"
                    /*onChange={e=>setService(e.target.value)} */ className="text-sm w-full bg-white px-4 py-2.5 border border-solid border-gray-200 rounded-sm focus:border-transparent focus:outline-none focus:ring-3 focus:ring-primary-100 focus:ring-opacity-30 transition-colors duration-300 ease-linear"
                  >
          ...
          <div className="mb-8">
            <iframe
                title="myFrame"
              src="https://calendly.com/michellehighechelon/30min"
              className="w-full h-full overflow-hidden min-h-[1200px]"
            ></iframe>
          </div>
        )}
      </div>
